...
public class 魔方 :MoonSingleton<魔方>
{
    int 魔方LayerID;
    ...
    void Start()
    {
        魔方LayerID = LayerMask.NameToLayer("魔方");
    ...
    private void 检测鼠标拖动()
    {
        ...
        if (Input.GetMouseButton(0) && 被点到的小正方体 != null && !FightMgr.Instance.start)
        {
            //从鼠标点击的位置发射一根射线
    ...
    private void FixedUpdate()
    {
        if (是否正在旋转)
        {
            ...
            Quaternion rot = Quaternion.Slerp(旋转的点.transform.rotation, rotation, 0.06f);
